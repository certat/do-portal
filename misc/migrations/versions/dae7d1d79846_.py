...
Revision ID: dae7d1d79846
Revises: None
Create Date: 2019-02-18 10:29:14.048733

"""

# revision identifiers, used by Alembic.
revision = 'dae7d1d79846'
down_revision = None
...
def upgrade():
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('is_sla', sa.Boolean(), nullable=True),
    sa.Column('deleted', sa.Integer(), nullable=True),
    ...
    sa.Column('deleted', sa.Integer(), nullable=True),
    sa.Column('ts_deleted', sa.DateTime(), nullable=True),
    sa.Column('pgp_key_id', sa.String(length=255), nullable=True),
    sa.Column('pgp_key_fingerprint', sa.String(length=255), nullable=True),
    sa.Column('pgp_key', sa.Text(), nullable=True),
    sa.Column('smime', sa.Text(), nullable=True),
    sa.Column('smime_filename', sa.String(length=255), nullable=True),
    sa.Column('coc', sa.Text(), nullable=True),
    sa.Column('coc_filename', sa.String(length=255), nullable=True),
    sa.Column('sms_alerting', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['country_id'], ['countries.id'], ),
    sa.ForeignKeyConstraint(['membership_role_id'], ['membership_roles.id'], ),
    sa.ForeignKeyConstraint(['organization_id'], ['organizations.id'], ),
    ...
    sa.Column('test_type', sa.Enum('request', name='test_type_enum'), nullable=True),
