  ...
  grunt.initConfig({
    ...
    jshint: {
      options: {
        ...
        // Warning This option has been deprecated and will be removed in the next major release of JSHint. http://jshint.com/docs/options/#newcap
      },
      all: {
        src: [
          'Gruntfile.js',
    ...
    replace: {
      devel: {
        options: {
          patterns: [{
            json: grunt.file.readJSON('./config/envs/devel.json')
          }]
        },
        files: [{
          expand: true,
      ...
      production: {
        options: {
          patterns: [{
            json: grunt.file.readJSON('./config/envs/production.json')
          }]
        },
        files: [{
          expand: true,
