...
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (236, 'set db_host', 6, true, false, '1', 5, 'VarVal', '{"global":0,"value":"cert_db","variable":"db_host"}');
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (245, 'query organisation_automatic_id', 6, true, false, '1', 11, 'VarQueryPath', '{"var_result":"organisation_automatic_id","query_path":"//organisation_automatic_id","input":"[% db_response %]"}');
...
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (107, 'set host', 1, true, false, '1', 5, 'VarVal', '{"global":0,"variable":"host","value":"http://customer-portal:5002"}');
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (109, 'set username', 2, true, false, '1', 5, 'VarVal', '{"value":"cert@master.at","variable":"username","global":0}');
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (227, 'disconnect from backend DB', 9, true, false, '1', 11, 'DBDisconnect', '{}');
...
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (121, 'connect to portal', 1, true, false, '1', 4, 'SeleniumConnect', '{"port":"4444","host":"epplication_selenium","identifier":"selenium"}');
...
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (239, 'create org', 4, true, false, '1', 11, 'DB', '{"sql":"insert into fody.organisation_automatic (name, ripe_org_hdl, import_source, import_time) values (''name_[%ripe_org%]'', ''ripe_org_hdl_[%ripe_org%]'', ''ripe'', NOW());","var_result":"db_response"}');
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (240, 'select organisation_automatic_id', 5, true, false, '1', 11, 'DB', '{"sql":"SELECT organisation_automatic_id FROM fody.organisation_automatic WHERE ripe_org_hdl = ''ripe_org_hdl_[%ripe_org%]'';","var_result":"db_response"}');
...
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (241, 'create contact', 8, true, false, '1', 11, 'DB', '{"var_result":"db_response","sql":"insert into fody.contact_automatic (firstname, lastname, email, import_source, import_time, organisation_automatic_id) values (''firstname_[%ripe_org%]'', ''lastname_[%ripe_org%]'', ''email@ripe_org_[%ripe_org%].at'', ''ripe'', NOW(), [%organisation_automatic_id%]);"}');
...
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (244, 'check org id', 7, true, false, '1', 11, 'VarCheckRegExp', '{"regexp":"\\d+","value":"[%organisation_automatic_id%]","modifiers":"xms"}');
...
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (194, 'request Organizations page', 2, true, false, '1', 8, 'SeleniumClick', '{"locator":"link_text","identifier":"selenium","selector":"Organizations"}');
INSERT INTO public.step (id, name, "position", active, highlight, condition, test_id, type, parameters) VALUES (199, 'sleep', 1, true, false, '1', 8, 'Script', '{"var_stdout":"script_response","command":"sleep 3"}');
...
SELECT pg_catalog.setval('public.step_id_seq', 245, true);
